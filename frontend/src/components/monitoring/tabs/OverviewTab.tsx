    ...
    <div>
      ...
      <div className="astat-grid">
        <StatCard
          ...
          icon={Activity}
          color="purple"
          value={fmtThousand(overview.data?.total_requests)}
        ...
        <StatCard
          ...
          severity={
            successRate < 90 ? "crit" : successRate < 97 ? "warn" : "ok"
          }
        />
        <StatCard
          label="Avg Latency"
          icon={Timer}
          color="blue"
          value={fmtMs(overview.data?.avg_latency_ms)}
        />
        <StatCard
          label="Total Cost"
          icon={Coins}
          color="amber"
          value={fmtUsd(overview.data?.total_cost_usd, 2)}
        />
        <StatCard
          label="Active Users"
          icon={Users}
          color="indigo"
          value={fmtThousand(overview.data?.active_users)}
        />
        <StatCard
          label="Error Rate"
          icon={AlertOctagon}
      ...
      <div className="apanel-row">
        <div className="apanel apanel-full">
          ...
          <p className="apanel-desc">
            Klik salah satu tahap untuk melihat request paling lambat di tahap
            itu.
          </p>
