...
3. KELAS Settings (mewarisi BaseSettings)
   ...
   - PENGATURAN MONITORING & OBSERVABILITY (NEW):
     - ENABLE_REQUEST_METRICS (bool, default True):
       Aktifkan/matikan pencatatan request_metrics ke database.
       Jika False, semua persist_metrics() dan persist_quota_rejection() jadi no-op.
       Berguna untuk mematikan monitoring saat testing atau debugging tanpa mengubah kode.
